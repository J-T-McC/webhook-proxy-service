...
| 5 | Payload storage & retention | Technical Design | Principal Engineer | None blocking. Q-05-03 (GC vs. ADR-011 FIFO claim state, retention bookkeeping vs. ADR-010 immutable raw entity, dispatched-output store placement) is PE-owned and gates technical design only | **PRD-05 Approved (Owner 2026-08-05)**; V4/V5/V6 settled in PRD (V4 offline-capture deferred, V5 retention-tier deferred — 30 days all teams, V6 regions deferred / Postgres not a PM call); Q-05-01 RESOLVED Option B — no payload-inspection UI at #5, no Designer gate; Q-05-02 RESOLVED — both defaults confirmed |
