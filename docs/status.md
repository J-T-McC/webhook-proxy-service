...
| 4 | Queued processing (FIFO & Async) | Task Planning | Task Planner (tasks-04) | Q-04-01 RESOLVED; mid-flight-mode-change stays within design (no UI warning). V3/V8 Owner-deferred, non-blocking | PRD-04 Approved (Owner 2026-08-04); design-04 Approved (PM 2026-08-04); plan-04 PE-self-certified; ADR-011 Accepted + data-model change approved (Owner 2026-08-04) |
