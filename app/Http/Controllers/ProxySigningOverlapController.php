 ...
 * plan-10 §API) — the signing-surface counterpart to
 * `ProxyVerificationOverlapController`. `SecretStore::endOverlap()` (T14)
 * is idempotent — this controller adds no guard of its own beyond
 * authorization.
 */
